...
function PartyBox({ label, color, features, splits, active, delay = 0 }: PartyBoxProps) {
  return (
    <motion.div
      ...
      transition={{ delay }}
      className="rounded-xl p-3 border-2 backdrop-blur-sm min-w-[140px]"
    ...
    >
      ...
      <div className="space-y-1 mb-2">
        {features.map((f, i) => (
          <motion.div
            ...
            className="text-[9px] bg-black/20 rounded px-2 py-0.5 text-center"
          >
            {f}
          </motion.div>
        ))}
      ...
      {splits && (
        ...
        >
          <div className="text-[8px] opacity-60 mb-1">Split Candidates:</div>
          {splits.map((s, i) => (
            <motion.div
              key={s}
              ...
              className={`text-[9px] rounded px-2 py-0.5 mb-0.5 ${active ? "bg-white/20" : "bg-black/10"}`}
            >
              {s}
            </motion.div>
          ))}
      ...
      <div className="relative min-h-[420px]">
        <AnimatePresence mode="wait">
          ...
          {step === "coordination" && (
            ...
            >
              ...
              <div className="flex items-start gap-8">
                {[
                  ...
                  >
                    ...
                    <div className="text-[9px] font-mono">{p.split}</div>
                    <div className="text-[8px] opacity-60">🔒 encrypted</div>
                  </motion.div>
                ))}
              </div>
              ...
              <motion.div
                ...
                className="rounded-xl p-4 border-2 border-emerald-500 bg-emerald-500/10"
              >
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  transition={{ delay: 1 }}
                  className="text-[9px] font-mono space-y-1"
                >
                  ...
                  <motion.div
                    ...
                    className="bg-white/20 rounded p-1"
                  >
            ...
            >
              ...
              <svg width="400" height="200" className="overflow-visible">
                ...
                <TreeNode
                  ...
                  delay={0}
                  active
                  children={{ leftX: 100, rightX: 300, leftY: 90, rightY: 90 }}
                />
          ...
          {step === "result" && (
            ...
            >
              {/* Final Tree Summary */}
              <svg width="400" height="180" className="overflow-visible">
                <TreeNode
                  label="Income>80K"
                  color={partyB.color}
                  x={200}
